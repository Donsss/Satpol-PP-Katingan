<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            {{ $pageTitle ?? __('Tambah Tugas & Fungsi') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.tugas.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="myeditorinstance" name="konten" rows="15" class="text-editor block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Tuliskan tugas dan fungsi instansi di sini...">{{ old('konten') }}</textarea>
