    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Edit Anggota Struktur Organisasi
            </h2>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.organisasi.update', $organizationalStructure->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $organizationalStructure->name) }}" 
                            ...
                            <div>
                                ...
                                <input type="text" name="position" id="position" value="{{ old('position', $organizationalStructure->position) }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" required>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="nip" id="nip" value="{{ old('nip', $organizationalStructure->nip) }}"
                            ...
                            <label class="block text-sm font-medium text-gray-700">Ganti Foto (Opsional)</label>
                             @if($organizationalStructure->photo)
                                <div class="mt-2">
                                    ...
                                    <img src="{{ asset('storage/' . $organizationalStructure->photo) }}" alt="Foto saat ini" class="w-32 h-32 object-cover rounded-md">
                                </div>
                            @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t">
                            <div>
                                ...
                                <input type="number" name="section" id="section" value="{{ old('section', $organizationalStructure->section) }}"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" 
                                       required min="1">
                            ...
                            <div>
                                ...
                                <input type="number" name="order" id="order" value="{{ old('order', $organizationalStructure->order) }}" 
                                       class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" 
                                       required min="1">
